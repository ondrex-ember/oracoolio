...
const numerologyTexts = {
    ...
    lifePath: {
        ...
        "11": { title: "Mistrovská intuice (11)", title_en: "Master Intuition (11)", content: "Máš obrovský duchovní potenciál a intuici. Můžeš být inspirací, ale čelíš vnitřnímu napětí." },
        "22": { title: "Mistrovský budovatel (22)", title_en: "Master Builder (22)", content: "Dokážeš proměnit i ty nejodvážnější sny v realitu. Máš obrovskou sílu." },
        "33": { title: "Mistrovský učitel (33)", title_en: "Master Teacher (33)", content: "Nejvyšší duchovní vibrace. Naprostá obětavost a služba lidstvu." }
    },
    personalYear: {
    ...
    personalDay: {
        "1": { title: "Akce a start", title_en: "Action and Start", content: "Dnes je den pro nové začátky. Převezmi iniciativu a udělej důležitá rozhodnutí. Nečekej na ostatní." },
        "2": { title: "Spolupráce a klid", title_en: "Cooperation and Calm", content: "Energie dneška přeje diplomacii. Nespěchej, naslouchej druhým a buď opatrný na své emoce." },
        "3": { title: "Radost a komunikace", title_en: "Joy and Communication", content: "Den ideální pro zábavu, setkávání s přáteli a kreativní tvorbu. Běž ven a usmívej se." },
        "4": { title: "Povinnosti a řád", title_en: "Duties and Order", content: "Dnes se nic neudělá samo. Je to den tvrdé práce, úklidu a dotahování restů. Drž se rutiny." },
        "5": { title: "Pohyb a změna", title_en: "Movement and Change", content: "Očekávej neočekávané! Dnes naruší tvé plány překvapení. Buď flexibilní a zkus něco úplně nového." },
        "6": { title: "Rodina a péče", title_en: "Family and Care", content: "Těžištěm dneška je domov a tvoji blízcí. Urovnej spory, uvař dobrou večeři a odpočívej." },
        "7": { title: "Přemýšlení a samota", title_en: "Thinking and Solitude", content: "Zpomal. Dnes není dobrý den na těžká byznys rozhodnutí. Zůstaň chvíli sám a poslouchej svou intuici." },
        "8": { title: "Peníze a moc", title_en: "Money and Power", content: "Den pro velké obchody. Dnes máš tah na branku, řeš úřední věci, finance a nenech se odradit." },
        "9": { title: "Dokončování a karma", title_en: "Completion and Karma", content: "Zavři za sebou staré dveře. Vyhoď nepotřebné věci, odpusť staré křivdy. Nic nového dnes nezačínej!" }
    },
    nameSoul: {
        "1": { title: "Touha po vedení", title_en: "Desire for Leadership", content: "Vnitřně toužíš být respektován jako samostatná vůdčí osobnost." },
        "2": { title: "Touha po spojení", title_en: "Desire for Connection", content: "Hluboko uvnitř toužíš po dokonalé a harmonické lásce a partnerství." },
        "3": { title: "Touha po radosti", title_en: "Desire for Joy", content: "Chceš se bavit, tvořit a šířit optimismus do svého okolí." },
        "4": { title: "Touha po jistotě", title_en: "Desire for Security", content: "Tvým nejhlubším přáním je mít pevný bod, řád a materiální bezpečí." },
        "5": { title: "Touha po volnosti", title_en: "Desire for Freedom", content: "Uvnitř tvé duše je divoký nomád, který nechce být ničím svazován." },
        "6": { title: "Touha po rodině", title_en: "Desire for Family", content: "Tvým snem je vytvořit láskyplný a krásný domov pro tvé blízké." },
        "7": { title: "Touha po pravdě", title_en: "Desire for Truth", content: "Chceš poznat tajemství vesmíru a nalézt klid daleko od hlučného davu." },
        "8": { title: "Touha po moci", title_en: "Desire for Power", content: "Hluboko uvnitř chceš budovat impérium a mít kontrolu nad svým osudem." },
        "9": { title: "Touha po službě", title_en: "Desire for Service", content: "Tvá duše touží po spravedlnosti a nápravě křivd ve světě." },
        "11": { title: "Touha po osvícení (11)", title_en: "Desire for Enlightenment (11)", content: "Tvá duše je stará a velmi citlivá. Hluboko uvnitř toužíš přinášet lidem světlo, inspiraci a duchovní poznání. Nejde ti o moc, ale o pravdu." },
        "22": { title: "Touha po tvoření (22)", title_en: "Desire for Creation (22)", content: "V nitru jsi vizionář a mistr budovatel. Tvá duše nechce jen snít, ale touží zanechat po sobě ve světě hmatatelný, obrovský odkaz pro další generace." }
    },
    namePersonality: {
        "1": { title: "Vnímán jako: Vůdce", title_en: "Perceived as: Leader", content: "Navenek působíš velmi sebejistě, nezávisle a občas možná až příliš dominantně." },
        "2": { title: "Vnímán jako: Přítel", title_en: "Perceived as: Friend", content: "Lidé tě na první pohled vnímají jako klidného, přátelského a nekonfliktního člověka." },
        "3": { title: "Vnímán jako: Bavič", title_en: "Perceived as: Entertainer", content: "Působíš šarmantně a vtipně, všude kam přijdeš, přinášíš s sebou dobrou náladu." },
        "4": { title: "Vnímán jako: Dříč", title_en: "Perceived as: Hard Worker", content: "Okolí tě vidí jako praktického, solidního a pracovitého člověka, na kterého je spolehnutí." },
        "5": { title: "Vnímán jako: Rebel", title_en: "Perceived as: Rebel", content: "Vyzařuje z tebe dynamika, sex-appeal a nevyzpytatelnost." },
        "6": { title: "Vnímán jako: Pečovatel", title_en: "Perceived as: Carer", content: "Vypadáš jako zodpovědný člověk s dobrým vkusem, u kterého každý najde radu a útěchu." },
        "7": { title: "Vnímán jako: Myslitel", title_en: "Perceived as: Thinker", content: "Působíš trochu odtažitě, tajemně a velmi inteligentně. Lidé k tobě cítí respekt." },
        "8": { title: "Vnímán jako: Šéf", title_en: "Perceived as: Boss", content: "Vyzařuješ autoritu, sebevědomí a materiální úspěch. Působíš silně." },
        "9": { title: "Vnímán jako: Filantrop", title_en: "Perceived as: Philanthropist", content: "Lidé v tobě vidí chápavého, štědrého a velkorysého člověka se širokým rozhledem." },
        "11": { title: "Vnímán jako: Vizionář (11)", title_en: "Perceived as: Visionary (11)", content: "Lidé z tebe cítí obrovské charisma a jakési nadpozemské vyzařování. Působíš jako inspirativní, vysoce inteligentní, ale občas trochu neuchopitelný a přecitlivělý člověk." },
        "22": { title: "Vnímán jako: Kapacita (22)", title_en: "Perceived as: Authority (22)", content: "Na první pohled působíš jako absolutní expert a nezpochybnitelná autorita. Okolí z tebe cítí sílu a věří, že dokážeš vyřešit i ty nejtěžší úkoly." }
    },
    nameDestiny: {
        "1": { title: "Průbojnost a vize", title_en: "Drive and Vision", content: "Tvé jméno tě předurčuje k tomu být lídrem a stát si za svým." },
        "2": { title: "Diplomacie a takt", title_en: "Diplomacy and Tact", content: "Vibrace jména tě vede k hledání kompromisů a propojování lidí." },
        "3": { title: "Kreativita a šarm", title_en: "Creativity and Charm", content: "Tvé jméno přitahuje pozornost a nese vibraci radosti." },
        "4": { title: "Řád a vytrvalost", title_en: "Order and Perseverance", content: "Jméno rezonuje s pevnou půdou pod nohama a stabilitou." },
        "5": { title: "Pohyb a nezávislost", title_en: "Movement and Independence", content: "Vibrace přináší do života cestování a touhu zkoušet nové věci." },
        "6": { title: "Láska a péče", title_en: "Love and Care", title_en: "Love and Care", content: "Tvé jméno nese obrovský ochranitelský potenciál a bezpečí." },
        "7": { title: "Mystická hloubka", title_en: "Mystical Depth", content: "Jméno tě obklopuje aurou tajemství a vede k analytickému myšlení." },
        "8": { title: "Síla a hojnost", title_en: "Strength and Abundance", content: "Tvé jméno je jako magnet na úspěch. Vyzařuje autoritu." },
        "9": { title: "Velkorysost a ideály", title_en: "Generosity and Ideals", content: "Vibrace tvého jména přesahuje tvé vlastní ego. Jsi rádcem." },
        "11": { title: "Inspirace (11)", title_en: "Inspiration (11)", content: "Předurčuje tě k tomu být duchovním majákem pro ostatní." },
        "22": { title: "Velké dílo (22)", title_en: "Great Work (22)", content: "Máš jméno člověka, který po sobě zanechá hmatatelný odkaz." }
    },
    maturity: {
        "1": { title: "Vlastní cesta", title_en: "Your Own Path", content: "Ve zralém věku objevíš svou skutečnou nezávislost a postavíš se plně na vlastní nohy." },
        "2": { title: "Harmonie", title_en: "Harmony", content: "Tvá moudrost tě povede k vytváření hlubokých spojení a harmonie s ostatními." },
        "3": { title: "Radost", title_en: "Joy", content: "Cílem tvého zrání je najít lehkost bytí a sdílet radost skrze tvořivost." },
        "4": { title: "Budovatel", title_en: "Builder", content: "Tvým cílem je vybudovat trvalé hodnoty, ať už v rodině, nebo v práci." },
        "5": { title: "Svoboda", title_en: "Freedom", content: "Ve zralém věku se osvobodíš od pout a tvůj život bude plný cestování a změn." },
        "6": { title: "Láska a péče", content: "Tvým životním naplněním bude péče o druhé a vytvoření bezpečného domova." },
        "7": { title: "Moudrost", title_en: "Wisdom", content: "Dospěješ k hlubokému duchovnímu pochopení a staneš se pro mnohé moudrým rádcem." },
        "8": { title: "Hojnost", title_en: "Abundance", content: "Ve zralém věku tě čeká sklizeň plodů tvé práce, moc a materiální stabilita." },
        "9": { title: "Odpouštění", title_en: "Forgiveness", content: "Dosáhneš nadhledu a tvým cílem bude pomáhat světu s hlubokou tolerancí." },
        "11": { title: "Inspirátor (11)", title_en: "Inspirator (11)", content: "Staneš se duchovním světlem pro své okolí s mimořádně probuzenou intuicí." },
        "22": { title: "Mistrovské dílo (22)", title_en: "Masterpiece (22)", content: "Ve druhé půli života vytvoříš něco velkolepého, co tě daleko přežije." }
    },
    karmicLessons: {
        "1": { title: "Lekce 1: Průbojnost a ego", title_en: "Lesson 1: Drive and Ego", content: "V tomto životě se učíš sebevědomí. Musíš se naučit říkat zdravé NE, nestát neustále v koutě a postavit se pevně za svými vlastními názory." },
        "2": { title: "Lekce 2: Takt a diplomacie", title_en: "Lesson 2: Tact and Diplomacy", content: "Tvá duše se učí diplomacii a trpělivosti. Tvým úkolem je naučit se naslouchat druhým bez okamžitého posuzování a vytvářet kolem sebe kompromis místo hádek." },
        "3": { title: "Lekce 3: Sebevyjádření a radost", title_en: "Lesson 3: Self-expression and Joy", content: "Tvou velkou lekcí je překonat plachost a vnitřní cenzuru. Učíš se nebrat život tak smrtelně vážně, uvolnit svou kreativitu a dovolit si být občas spontánní a hravý." },
        "4": { title: "Lekce 4: Řád a systém", title_en: "Lesson 4: Order and System", content: "Musíš se naučit osobní disciplíně a dotahování rozdělaných projektů do konce. Bez nalezení vnitřního řádu tě čeká v praktickém životě a financích chaos." },
        "5": { title: "Lekce 5: Změna a adaptabilita", title_en: "Lesson 5: Change and Adaptability", content: "Tvou lekcí je flexibilita. Učíš se nebát se zdravě zariskovat a opouštět staré nefunkční jistoty. Svět je plný změn a ty se jim nesmíš bránit zuby nehty." },
        "6": { title: "Lekce 6: Zodpovědnost a vztahy", title_en: "Lesson 6: Responsibility and Relationships", content: "Tvojí životní zkouškou jsou rodinné a partnerské vztahy. Učíš se nevyhýbat citovým závazkům vůči svým nejbližším a přijmout odpovědnost za lidi, kteří tě milují." },
        "7": { title: "Lekce 7: Víra a hloubka", title_en: "Lesson 7: Faith and Depth", content: "Tvá duše se učí naslouchat svému vnitřnímu hlasu. Tvým úkolem je přestat se spoléhat jen na čistou logiku a najít hlubší, duchovní hodnoty přesahující materiální svět." },
        "8": { title: "Lekce 8: Peníze a moc", title_en: "Lesson 8: Money and Power", content: "Musíš najít zdravý vztah k materiálním hodnotám. Naučit se peníze nejen vydělat, ale také se jimi nenechat zotročit. Učíš se balancovat mezi tvrdým byznysem a laskavostí." },
        "9": { title: "Lekce 9: Soucit a odpuštění", title_en: "Lesson 9: Compassion and Forgiveness", content: "Tvá nejtěžší lekce spočívá v naučení se bezpodmínečné lásce. Musíš se zbavit předsudků, naučit se odpouštět staré křivdy a otevřít srdce toleranci vůči celému světu." }
    },
    synastry: {
    ...
    pinnacles: {
        "1": { title: "Nezávislost a akce", title_en: "Independence and Action", content: "Doba učení se samostatnosti, prosazení vlastního ega a odvahy." },
        "2": { title: "Spolupráce a vztahy", title_en: "Cooperation and Relationships", content: "Fáze zaměřená na vztahy, diplomacii a budování harmonie." },
        "3": { title: "Kreativita a rozvoj", title_en: "Creativity and Development", content: "Období sociálních kontaktů, studia a tvůrčího vyjádření." },
        "4": { title: "Budování a práce", title_en: "Building and Work", content: "Tvrdá práce a vytváření pevných základů pro budoucnost." },
        "5": { title: "Změna a svoboda", title_en: "Change and Freedom", content: "Fáze nečekaných zvratů, cestování a osobní svobody." },
        "6": { title: "Rodina a domov", content: "Zaměření na domov, rodinu a komunitu. Péče o nejbližší." },
        "7": { title: "Zastavení a duchovno", title_en: "Stillness and Spirituality", content: "Fáze hledání vnitřní pravdy, studia a izolace." },
        "8": { title: "Sklizeň a finance", title_en: "Harvest and Finance", content: "Čas postoupit v kariéře a převzít moc. Finanční stabilita." },
        "9": { title: "Završení cyklu", title_en: "Completion of a Cycle", content: "Konec jednoho velkého cyklu. Doba loučení a přípravy na nové věci." },
        "11": { title: "Duchovní rozvoj (11)", title_en: "Spiritual Development (11)", content: "Silné období pro osobní růst. Může přinést slávu nebo nervové vypětí." },
        "22": { title: "Mistrovství (22)", title_en: "Mastery (22)", content: "Období, kdy můžeš vybudovat projekty s obrovským dopadem." }
    },
    gridLines: {
        "full_159": { title: "Rovina odhodlání (1-5-9)", title_en: "Line of Determination (1-5-9)", content: "Máš vrozenou podnikavost a aktivitu. Jsi houževnatý." },
        "full_357": { title: "Rovina pochopení (3-5-7)", title_en: "Line of Understanding (3-5-7)", content: "Vyznačuješ se obrovskou empatií a myšlenkovou bystrostí." },
        "full_147": { title: "Rovina praktičnosti (1-4-7)", title_en: "Line of Practicality (1-4-7)", content: "Mimořádná zručnost. Stojíš pevně nohama na zemi." },
        "full_258": { title: "Rovina emocí (2-5-8)", title_en: "Line of Emotions (2-5-8)", content: "Máš silný a bohatý emoční svět, magnetické charisma a přirozenou autoritu. Intuice a tah na branku jdou u tebe ruku v ruce." },
        "full_369": { title: "Rovina myšlení (3-6-9)", title_en: "Line of Thinking (3-6-9)", content: "Brilantní intelekt, analytická mysl a vynikající paměť." },
        ...
        "full_456": { title: "Rovina vůle (4-5-6)", title_en: "Line of Will (4-5-6)", content: "Disponuješ mimořádnou vůlí a vytrvalostí. Jednou vytyčený cíl nevzdáváš — dokážeš dotáhnout cokoliv do konce, i kdyby mělo celé okolí být proti tobě." },
        "full_789": { title: "Rovina akce (7-8-9)", title_en: "Line of Action (7-8-9)", content: "Člověk činu s hlubokým smyslem pro spravedlnost. Spojuješ duchovní hloubku, logiku a praktickou sílu — tvé výsledky jsou vidět a zanechávají trvalý otisk." },
        "empty_456": { title: "Rovina zklamání (4-5-6 prázdná)", title_en: "Line of Disappointment (4-5-6 empty)", content: "Tato prázdná linie ukazuje na nedorozumění a nutnost učit se trpělivosti." },
        "empty_258": { title: "Rovina vášně (2-5-8 prázdná)", title_en: "Line of Passion (2-5-8 empty)", content: "Ukazuje na potíže s nalezením vnitřního emocionálního středu." }
    },
    gridNumbers: {
        "1": { title: "Ego a komunikace", title_en: "Ego and Communication", missing: "Absence jedničky ukazuje na výzvu v oblasti sebevědomí.", "1x": "Máš problém vyjádřit své pocity slovy.", "2x": "Ideální rovnováha v komunikaci a zdravé sebevědomí.", "3x_plus": "Mentální přetlak, potřeba slovního ventilu." },
        "2": { title: "Intuice a empatie", title_en: "Intuition and Empathy", missing: "Chybí ti radar na nálady druhých. Uč se taktu.", "1x": "Slušná a vyvážená intuice, dobrý odhad na lidi.", "2x": "Vysoce nadprůměrná intuice, hraničící s přecitlivělostí.", "3x_plus": "Extrémní citlivost, sklon k nasávání problémů celého světa." },
        "3": { title: "Postřeh a představivost", title_en: "Perception and Imagination", missing: "Spoléháš na logiku a rutinu, chybí spontánnost.", "1x": "Vynikající duševní čilost a bleskový úsudek.", "2x": "Silný intelekt, bujná představivost.", "3x_plus": "Hyperaktivní mysl a roztěkanost do mnoha projektů." },
        "4": { title: "Praktičnost a řád", title_en: "Practicality and Order", missing: "Chybí ukotvení v materiálním světě. Létáš v oblacích.", "1x": "Jsi systematický a organizovaný.", "2x": "Sklony k workoholismu. Uč se relaxovat.", "3x_plus": "Extrémní fixace na detaily a neústupnost." },
        "5": { title: "Vášeň a svoboda", title_en: "Passion and Freedom", missing: "Chybí odvaha ke změnám. Zůstáváš v nevyhovující jistotě.", "1x": "Máš skvělé nápady a nebojíš se je uskutečnit.", "2x": "Obrovská energie a touha po osobní svobodě.", "3x_plus": "Sopka energie. Pravidla pro tebe neexistují." },
        "6": { title: "Harmonie a estetika", title_en: "Harmony and Aesthetics", missing: "Chybí porozumění pro harmonii, hádáš se místo kompromisů.", "1x": "Velký smysl pro rodinu, domov a estetiku.", "2x": "Silný smysl pro dokonalost a ochranitelství.", "3x_plus": "Utopická touha po dokonalé rodině, sklon k sebeobětování." },
        "7": { title: "Duchovno a karma", title_en: "Spirituality and Karma", missing: "Spoléháš na hmatatelné a logické věci.", "1x": "Vše chceš zažít na vlastní kůži. Rád lidem pomáháš.", "2x": "Složité karmické zkoušky. Hluboké emoce.", "3x_plus": "Jsi stará duše. Procházíš náročným životem." },
        "8": { title: "Logika a moc", title_en: "Logic and Power", missing: "Chybí chladná logika. Vrháš se do situací bez plánu.", "1x": "Vynikající smysl pro detail a materiálno.", "2x": "Obrovská touha po úspěchu a kontrole.", "3x_plus": "Extrém v touze po dominanci. Životní lekcí je pokora." },
        "9": { title: "Analýza a pravda", title_en: "Analysis and Truth", missing: "Chybí schopnost vidět věci v širších souvislostech.", "1x": "Potřebuješ všemu přijít na kloub.", "2x": "Problém věci prožívat, vše musíš rozpitvat.", "3x_plus": "Vysoké utopické ideály. Časté zklamání z nedokonalosti světa." }
    }
};
